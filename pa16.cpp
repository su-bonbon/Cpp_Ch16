...
int main() {
    ...
    std::vector<int> array2(2000);
    std::vector<int> array3(4000);
    std::vector<int> array4(8000);
    std::vector<int> array5(16000);
    Origin box;  // to keep original data
    // modern way to generate number
    std::iota(array1.begin(), array1.end(), 0);
    std::iota(array2.begin(), array2.end(), 0);
    std::iota(array3.begin(), array3.end(), 0);
    std::iota(array4.begin(), array4.end(), 0);
    std::iota(array5.begin(), array5.end(), 0);
    // suffle for random order
    std::random_shuffle(array1.begin(), array1.end());
    std::random_shuffle(array2.begin(), array2.end());
    std::random_shuffle(array3.begin(), array3.end());
    std::random_shuffle(array4.begin(), array4.end());
    std::random_shuffle(array5.begin(), array5.end());
